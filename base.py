...
class ResNet(nn.Module): #[3,4,6,3 for resent 50]
...
def ResNet50(img_channels= 3, num_classes=1000): 
    return ResNet(block, [3,4,6,3], img_channels, num_classes) #to change layers edit the list

def test():
    net=ResNet50()
    x=torch.randn(2,3,224,224) # 2, channels, idk idk
    y= net(x).to('cuda')
    print(y.shape)
